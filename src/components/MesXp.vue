...
<template>
    <div id="xp">
        ...
        <div id="left">
            <p :class="activeBloc === 0 ? 'active' : ''" class="company fw600" @click="ShowXp(0)">RandevTeam</p>
            <p :class="activeBloc === 1 ? 'active' : ''" class="company fw600" @click="ShowXp(1)">Profily</p>
        </div>
        <div id="right">
